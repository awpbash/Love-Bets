...
class Friend(db.Model):
    ...
    user_id_1 = Column(Integer, ForeignKey('users.email'))
    user_id_2 = Column(Integer, ForeignKey('users.email'))
...
class Match(db.Model):
    ...
    id = Column(Integer, primary_key=True)
    user1_id = Column(Integer, ForeignKey('users.email'))
    user2_id = Column(Integer, ForeignKey('users.email'))
...
class Swipe(db.Model):
    ...
    target_user_id = Column(Integer, ForeignKey('users.email'))
